...
function renderLifeExample(){
  ...
  $$('[data-life-answer]').forEach(b=>b.onclick=()=>{
    ...
    if(n===l.answer){
      ...
      b.classList.add('wrong');feedback.className='feedback error';feedback.textContent='💡 先做第1步：'+thinking[0];setTimeout(()=>b.classList.remove('wrong'),600);
    }
  });
}
